...
// These paths assume your images are in `public/team/` and `public/`.
...
const sambhu = "/team/sambhu.webp";
const ac = "/team/ac.webp";
const swayam = "/team/swayam.webp";
const prateekshya = "/team/prateekshya.webp";
...
const teamData = {
  authorities: [
    ...
    {
      id: "2",
      name: "VENKATA SRIDHAR THATIPARTHI",
      role: "MENTOR",
      image: sridhar,
  ...
  leads: [
    {
      id: "7",
      name: "AKASH",
      role: "MARKETING AND SPONSORSHIP",
      image: akash,
      about: "Pixel perfect.",
    },
    {
  ...
  members: [
    ...
    {
      id: "14",
      name: "ASHIS KUMAR SARKAR",
      role: "TECH",
      image: ashisKumarSarkar,
    },
    ...
    },
    {
      ...
      role: "RESEARCH AND CONTENT",
      image: debiPrasadSahoo,
    },
    {
      id: "18",
      name: "EKLAVYA ANAND SINGH",
      role: "RESEARCH AND CONTENT",
      image: eklavyaAnandSingh,
    },
    { id: "19", name: "HARSH YADAV", role: "TECH", image: harshYadav },
    { id: "20", name: "LOUHAN ROUT", role: "TECH", image: louhanRout },
    {
      id: "21",
      name: "MANISHA MOHANTY",
      role: "MEDIA AND GRAPHICS",
      image: manishaMohanty,
    },
    { id: "22", name: "NIMISH BOTHE", role: "TECH", image: nimishBothe },
    {
      id: "23",
      name: "NIRMAL KUMAR PATRA",
      role: "TECH",
      image: nirmalKumarPatra,
    },
    {
      id: "24",
      name: "OMM PRAKASH SAHOO",
      role: "TECH",
      image: ommPrakashSahoo,
    },
    {
      id: "25",
      name: "PIYUSH PRIYARANJAN",
      role: "TECH",
      image: piyushPriyaranjan,
    },
    {
      id: "26",
      name: "PRATYUSHA SATAPATHY",
      role: "TECH",
      image: pratyushaSathapathy,
    },
    {
      id: "27",
      name: "RATHIKRIND SAATHWIK",
      role: "MEDIA AND GRAPHICS",
      image: rathikrindSaathwik,
    },
    { id: "28", name: "RISHAL SWAIN", role: "TECH", image: rishalSwain },
    {
      id: "29",
      name: "RUDRA PRASAD MISHRA",
      role: "TECH",
      image: rudraPrasadMishra,
    },
    ...
    { id: "34", name: "SAMBHU PRASAD VERMA", role: "TECH", image: sambhu },
    {
      id: "35",
      name: "PRATEEKSHYA SENAPATI",
      role: "TECH",
      image: prateekshya,
    },
    { id: "36", name: "ACHYUTA SHRIMATE", role: "TECH", image: ac },
    {
      id: "37",
      name: "SWAYAM PRAGNYA MALLICK",
      role: "MEDIA AND GRAPHICS",
      image: swayam,
    },
  ],
  ...
  return (
    ...
    >
      ...
      <div className="w-[20vw] h-[20vw] relative sm:w-[22vw] sm:h-[22vw] md:w-[16vw] md:h-[16vw] lg:w-[14vw] lg:h-[14vw] max-w-[12rem] max-h-[12rem] mb-4">
        <img src={teamimg} className="h-full w-full" alt="Team member frame" />
        {member.image && (
          <img
            src={member.image}
...
function TeamSection2({ title, members }) {
  return (
    // <div className="w-full mb-12">
    //   <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold mb-6 border-b border-gray-600 pb-2 text-center sm:text-left">
    //     {title}
