...
import desktopBorder from '../assets/desktop-border(lp).svg';
import mobileBorder from '../assets/mobile-border(lp).svg';
import tarsLogo from '../assets/tars-logo(lp).svg';
    ...
    ">
       ...
       ${showSlide ? 'animate-slideUp' : ''}
        ...
        {windowWidth <= 767 && (
          <>
            ...
            <nav
              ...
              <ul>
                <li onClick={() => handleScroll(refs.aboutUsRef)}><a className="nav-list nav-tap-animation" href="#about-us">About Us</a></li>
                <li onClick={() => handleScroll(refs.latestRef)}><a className="nav-list nav-tap-animation" href="#latest">Latest</a></li>
                <li onClick={() => handleScroll(refs.pastRef)}><a className="nav-list nav-tap-animation" href="#past">Past</a></li>
                <li onClick={() => handleScroll(refs.projectsRef)}><a className="nav-list nav-tap-animation" href="#projects">Projects</a></li>
                <li onClick={() => handleScroll(refs.ourTeamRef)}><a className="nav-list nav-tap-animation" href="#team">Our Team</a></li>
                <li onClick={() => handleScroll(refs.galleryRef)}><a className="nav-list nav-tap-animation" href="#gallery">Gallery</a></li>
                <li onClick={() => handleScroll(refs.liveeventsRef)}><a className="nav-list nav-tap-animation" href="#events">Events</a></li>
              </ul>
            </nav>
          </>
        )}
        ...
        <nav id="desktop-nav" className="md:flex nav-bar">
          <ul>
            <li><a className="nav-list" onClick={() => handleScroll(refs.aboutUsRef)}><span className='relative hover:text-white-400 cursor-pointer transition-all ease-in-out before:transition-[width] before:ease-in-out before:duration-700 before:absolute before:bg-white before:h-[2px] before:w-0 hover:before:w-full before:bottom-0 before:left-0 before:origin-left'>About Us</span></a></li>
            <li><a className="nav-list" onClick={() => handleScroll(refs.latestRef)}><span className='relative hover:text-white-400 cursor-pointer transition-all ease-in-out before:transition-[width] before:ease-in-out before:duration-700 before:absolute before:bg-white before:h-[2px] before:w-0 hover:before:w-full before:bottom-0 before:left-0 before:origin-left'>Blogs</span></a></li>
            <li><a className="nav-list" onClick={() => handleScroll(refs.pastRef)}><span className='relative hover:text-white-400 cursor-pointer transition-all ease-in-out before:transition-[width] before:ease-in-out before:duration-700 before:absolute before:bg-white before:h-[2px] before:w-0 hover:before:w-full before:bottom-0 before:left-0 before:origin-left'>Past</span></a></li>
            <li><a className="nav-list" onClick={() => handleScroll(refs.projectsRef)}><span className='relative hover:text-white-400 cursor-pointer transition-all ease-in-out before:transition-[width] before:ease-in-out before:duration-700 before:absolute before:bg-white before:h-[2px] before:w-0 hover:before:w-full before:bottom-0 before:left-0 before:origin-left'>Projects</span></a></li>
            <li><a className="nav-list" onClick={() => handleScroll(refs.ourTeamRef)}><span className='relative hover:text-white-400 cursor-pointer transition-all ease-in-out before:transition-[width] before:ease-in-out before:duration-700 before:absolute before:bg-white before:h-[2px] before:w-0 hover:before:w-full before:bottom-0 before:left-0 before:origin-left'>Our Team</span></a></li>
            <li><a className="nav-list" onClick={() => handleScroll(refs.galleryRef)}><span className='relative hover:text-white-400 cursor-pointer transition-all ease-in-out before:transition-[width] before:ease-in-out before:duration-700 before:absolute before:bg-white before:h-[2px] before:w-0 hover:before:w-full before:bottom-0 before:left-0 before:origin-left'>Gallery</span></a></li>
            <li><a className="nav-list" onClick={() => handleScroll(refs.liveeventsRef)}><span className='relative hover:text-white-400 cursor-pointer transition-all ease-in-out before:transition-[width] before:ease-in-out before:duration-700 before:absolute before:bg-white before:h-[2px] before:w-0 hover:before:w-full before:bottom-0 before:left-0 before:origin-left'>Events</span></a></li>
          </ul>
        </nav>
      </div>
    </div>
